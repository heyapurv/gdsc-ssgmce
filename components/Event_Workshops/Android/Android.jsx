...
export default () => {
  return (
    <>
    <div>
        <h1 className="text-center underline text-4xl my-5 text-gray-600 font-bold">
   ...
   <div className=" sm:flex">
    <div > 
        <Carousel
      className="rounded-3xl w-80 sm:w-[800px] mx-auto sm:ml-10 sm:mb-10 sm:h-[500px]" 
    ...
    <div className="mt-5 sm:mt-0">
        ...
        <section className="sm:py-10 py-8">
            <div className="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8">
                ...
                <div className="mt-12">
                    <ul className="flex  items-center justify-center gap-y-10 sm:flex-row sm:flex-wrap lg:divide-x">
                        {
                            stats.map((item, idx) => (
