export default () => {
    ...
    const contactMethods = [
        {
            ...
            link: {
                name: "Join Us",
                href: "https://gdsc.community.dev/shri-sant-gajanan-maharaj-college-of-engineering-shegaon/"
            },
        },
        {
            icon:
    ...
    return (
        <section className="py-14">
            <div className="max-w-screen-3xl mx-auto px-4 text-gray-600 gap-12 md:px-10 lg:flex">
                    ...
                    <ul className="mt-12 gap-y-6 gap-x-12 items-center md:flex lg:gap-x-0 lg:mt-0">
                        {
                            contactMethods.map((item, idx) => (
                                <li key={idx} className="space-y-3 border-t py-6 md:max-w-sm md:py-0 md:border-t-0 lg:border-l lg:px-12 lg:max-w-none">
                                    ...
                                    <a href={item.link.href} target="_blank" className="flex items-center gap-1 text-sm text-indigo-600 duration-150 hover:text-indigo-400 font-medium">
                                        {item.link.name}
